        ...
        <Container fullWidth>
          {loading ? (
            ...
            <>
              ...
              <h2 className="text-cream font-medium mb-3">Our Gallery</h2>
              <p className="text-white max-w-xl">
                A few favorites from past orders. See something you like? Tap it
                to order one just like it.
              </p>
            </>
          )}
        </Container>
