function CardSkeleton() {
  return (
    <div
      aria-hidden="true"
      className="flex flex-col overflow-hidden rounded-2xl border-cream bg-white shadow-md "
    >
      ...
      <div className="z-5 p-3 md:p-4 flex flex-1 flex-col justify-center gap-2">
