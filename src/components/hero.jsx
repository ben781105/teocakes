    ...
    <Section id="hero">
      <div className="grid md:grid-cols-2 gap-10 items-center">
        <div className="flex flex-col gap-5">
          <p className="font-script text-base font-medium text-orange-600  tracking-wide">
          ...
          <p className="text-gray-600 text-base md:text-lg max-w-md">
            Every cake is prepared fresh from scratch — no shortcuts, just good
            ingredients and a lot of patience.
          </p>
